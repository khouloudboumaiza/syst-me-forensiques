...
//#region node_modules/.nitro/vite/services/ssr/assets/alerts-D_G-TX7X.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var API_URL = "http://localhost:8000";
var explanationCache = {};
async function fetchAIExplanation(rule, target, source, details, severity) {
...
function AIExplainCell({ rule, target, source, details, severity }) {
