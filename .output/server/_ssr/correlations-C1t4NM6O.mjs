...
//#region node_modules/.nitro/vite/services/ssr/assets/correlations-C1t4NM6O.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, {
		...
		children: [
			...
			!isLoading && !isError && correlated.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Network, { className: "h-10 w-10 mx-auto mb-3 text-muted-foreground opacity-30" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-sm text-muted-foreground",
					children: selectedFileId ? `Aucune corrélation détectée pour ${selectedFileName ?? "le fichier sélectionné"}. Les corrélations apparaissent automatiquement quand des indicateurs (IPs, hashs, cibles) sont partagés avec d'autres fichiers du même cas.` : "Aucune corrélation détectée. Les corrélations apparaissent automatiquement quand des indicateurs (IPs, hashs, cibles) sont partagés entre 2+ fichiers uploadés dans le même cas."
				})]
			}),
